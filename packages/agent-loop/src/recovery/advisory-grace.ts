...
export function advisoryGraceEnabled(env: Record<string, string | undefined>): boolean {
...
export function advisoryGraceBudget(env: Record<string, string | undefined>): number {
