...
import { prepareTurnInput, runTurnKernel, createTurnKernelLoopHost } from '../dist/turn/index.js';
...
test('kernel-lock: @ppeng/agent-core subpath exports resolve', async () => {
  ...
  assert.equal(typeof turn.createTurnKernelLoopHost, 'function');
...
test('kernel-lock: turn barrel exports prepareTurnInput and runTurnKernel; loop barrel exports createAgentLoop', () => {
  ...
  assert.equal(typeof createTurnKernelLoopHost, 'function');
