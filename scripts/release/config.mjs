...
export function loadReleaseConfig(repoRoot = process.cwd()) {
  ...
  return {
    ...
    stableWebUrl: (process.env.EVOLUTION_RELEASE_STABLE_URL ?? 'http://127.0.0.1:23000').replace(/\/$/, ''),
