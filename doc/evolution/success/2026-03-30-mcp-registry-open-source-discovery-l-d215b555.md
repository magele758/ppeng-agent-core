...
ok 5 - HybridModelRouterAdapter last_user scope ignores images only in older turns
  ---
  duration_ms: 0.114042
  type: 'test'
  ...
# (node:51155) ExperimentalWarning: SQLite is an experimental feature and might change at any time
